...
<?php include_once "JD_enc_municipios.php" ?>
<div class="row">
			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<?php foreach($municipios as $mun)
					{
						?>
						<tr>
							<td><?php echo $mun->nom_dpto ?></td>
							<td><?php echo $mun->id_municipio ?></td>
							<td><?php echo $mun->nom_municipio ?></td>
							<td><a class="btn btn-warning" href="JD_edit_municipios.php?id_dpto=<?php echo $mun->id_dpto;?>&id_municipio=<?php echo $mun->id_municipio;?>">Editar 📝</a></td>
							<td><a class="btn btn-danger" href="JD_elim_municipios.php?id_dpto=<?php echo $mun->id_dpto;?>&id_municipio=<?php echo $mun->id_municipio;?>">Eliminar 🗑️</a></td> 
						</tr>
					<?php
					} ?>
				</tbody>
