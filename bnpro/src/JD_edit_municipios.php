...
$sentencia = $base_de_datos->query("SELECT id_dpto, nom_dpto FROM tab_dptos ORDER BY 1");
...
<div class="row">
	<div class="col-12">
		<h1>Editar</h1>
		<form action="JD_update_municipios.php" method="GET">
			...
			<div>
				...
				<select name="id_dpto" id="id_dpto" class="form-control">
					...
					<option value="<?php echo $municipio->id_dpto ?>"><?php echo $dpto->nom_dpto ?></option>
					<?php }?>
				</select>  
			...
			<a href="./JD_listar_municipios.php" class="btn btn-warning">Volver</a>
		</form>
	</div>
</div>
