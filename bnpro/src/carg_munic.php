...
$departamentoId = isset($_GET['id_dpto']) ? $_GET['id_dpto'] : null;
if ($departamentoId !== null) {
    ...
    $consulta = $base_de_datos->prepare('SELECT  id_municipio, nom_municipio FROM tab_municipios WHERE id_dpto = ? ORDER BY 2');
