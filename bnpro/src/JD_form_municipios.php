...
<div class="row">
	<div class="col-12">
		...
		<form action="./JD_insert_municipios.php" method="POST">
...
<!-- TRAYENDO LOS DEPARTAMENTOS DESDE LA TABLA tab_dptos-->
			...
			<div class="form-group">
				...
				<input required name="id_municipio" type="number" maxlength=3 minlength=3 id="id_municipio" placeholder="Municipio" class="form-control">
			</div>
			<div class="form-group">
			...
			<a href="JD_listar_municipios.php" class="btn btn-warning">Ver todas</a>
		</form>
	</div>
