	...
	<div class="col-12">
		...
		<form action="./insertar_regiones.php" method="POST">
			<div class="form-group">
				<label for="id_region">ID. de la Región</label>
<!--				echo '<script>', 'showMessage();', '</script>';-->
				<input required name="id_region" type="number" min="1" max="10" id="id_region" placeholder="Digite acá la región" class="form-control">
			</div>
			<div class="form-group">
