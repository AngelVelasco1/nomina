    ...
    <!--    <?php
        ...
        <div class="collapse navbar-collapse" id="miNavbar">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="./listar_factura.php">Listar</a>
                </li>
<!--            <li class="nav-item">
                    <a class="nav-link" href="./sales_invoice">Listar (cursor)</a>
                </li>-->
                <li class="nav-item">
                    <a class="nav-link" href="./agregar_factura.php">Agregar</a>
                </li>
                <li class="nav-item">
